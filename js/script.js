...
function renderProfile(data) {
    console.log('renderProfile skills:', data.skills);
            ...
            data.skills.forEach(category => {
                if (category && Array.isArray(category.items)) {
                    ...
                    categoryBlock.innerHTML = `
                        ...
                        <div class="skill-category-items"></div>
                    `;

                    const itemsContainer = categoryBlock.querySelector('.skill-category-items');
                    category.items.forEach(skill => {
                        ...
                        skillItem.innerHTML = `
                            ...
                            <div>
                                ...
                                ${skill.level ? `<div class="skill-level-text">${skill.level}</div>` : ''}
                            </div>
                        `;
                    ...
                    skillItem.innerHTML = `
                        ...
                        <div>
                            ...
                            ${category.level ? `<div class="skill-level-text">${category.level}</div>` : ''}
                        </div>
                    `;
                    skillsGrid.appendChild(skillItem);
                } else {
                    console.warn('Unexpected skill format:', category);
                }
            });
        } else {
            skillsGrid.innerHTML = '<div class="skill-empty">Skills data not available.</div>';
        }
    }
    ...
    data.forEach(exp => {
        ...
        expItem.innerHTML = `
            <div class="exp-header">
                ${exp.logo ? `<img src="${exp.logo}" alt="${exp.organization} logo" class="exp-logo">` : ''}
                <div>
